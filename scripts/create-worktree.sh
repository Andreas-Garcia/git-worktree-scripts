...
if [ -f "$REPO_ROOT/scripts/setup-worktree.sh" ]; then
    ...
    bash "$REPO_ROOT/scripts/setup-worktree.sh" "$WORKTREE_ABS_PATH"
    echo "✓ Repository-specific setup complete"
    echo ""
elif [ -f "$WORKTREE_ABS_PATH/scripts/setup-worktree.sh" ]; then
    echo "Running repository-specific setup..."
    cd "$WORKTREE_ABS_PATH"
    bash "$WORKTREE_ABS_PATH/scripts/setup-worktree.sh" "$WORKTREE_ABS_PATH"
    echo "✓ Repository-specific setup complete"
    echo ""
fi
